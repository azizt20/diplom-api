...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='medicine_pictures/2022-6-6/')),
            ],
        ),
        migrations.CreateModel(
            name='TypeProduct',
            fields=[
                ...
                ('sub', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='shop.typeproduct')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('type_medicine', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='shop.typeproduct')),
            ],
        ),
        migrations.CreateModel(
            name='OrderModel',
